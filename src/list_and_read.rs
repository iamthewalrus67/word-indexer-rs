...
use crate::mt::{MtDeque, size_limits};

pub fn read_files_from_deque(mt_d_filenames: &MtDeque<Option<Box::<PathBuf>>>, mt_d_file_contents: &MtDeque<Option<(String, String)>>) {
    loop {
